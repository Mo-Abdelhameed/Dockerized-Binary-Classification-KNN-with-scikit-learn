...
class HyperParameterTuner:
    ...
    def _get_objective_func(
        ...
        def objective_func(trial):
            ...
            # train model
            classifier = Classifier.train_predictor_model(train_X, train_y, hyperparameters)
            # evaluate the model
            score = round(Classifier.evaluate_predictor_model(classifier, valid_X, valid_y), 6)
